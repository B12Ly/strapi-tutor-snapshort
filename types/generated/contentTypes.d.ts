...
export interface ApiCongractCongract extends Struct.CollectionTypeSchema {
  collectionName: 'congracts';
  info: {
    description: '';
    displayName: 'Congrate';
    pluralName: 'congracts';
    singularName: 'congract';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCongrate2Congrate2 extends Struct.CollectionTypeSchema {
  collectionName: 'congrate2s';
  info: {
    description: '';
    displayName: 'Congrate2';
    pluralName: 'congrate2s';
    singularName: 'congrate2';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    PromitionName: Schema.Attribute.String;
    PromotePromo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::congract.congract': ApiCongractCongract;
      'api::congrate2.congrate2': ApiCongrate2Congrate2;
      'api::count-down.count-down': ApiCountDownCountDown;
